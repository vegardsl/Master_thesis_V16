...
This thesis presents and documents the work that was done during the master's project, \textbf{TTK4900}, in Engineering Cybernetics. This thesis thesis is worth 30 credits (studiepoeng), and the project duration is set to 22 full-time weeks. The student shall gain in depth knowledge of a specific topic, and be able to choose the correct tools to solve a problem. Furthermore, the st
