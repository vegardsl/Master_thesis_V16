...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.8\textwidth]{minimum_graph}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.5\textwidth]{rtabmap_graph}
    \caption{Conceptual illustration of a graph created by \ac{RTAB-Map} over time $1 \leq t \leq 8 $. A loop closure hypothesis was accepted at $t=7$, as shown by the yellow arrow. Similarities between $L_2$ and $L_7$ is sufficient to accept this as a loop closure.}
