...
A feasibility study performed by researchers from \ac{IFA} identified several topside production tasks and ranked them according to their resource demand. 
...
A mobile robot operating on a normally unmanned platform in a harsh environment, implies that is is subjected to many of the same design philosophies that apply to subsea equipment. 
...
\subsubsection{Topside Offshore Robotic Maintenance}
...
Among the research groups working on robotic maintenance for O\&G, ABB, \ac{Fraunhofer IPA} and NREC  at  Carnegie
Melllon University stand out as major contributors to the field. 

\begin{wrapfigure}{l}{0.5\textwidth}
	%\vspace{-20pt}
	\begin{center}
		\includegraphics[width=0.48\textwidth]{sensabot}
	\end{center}
	
	\caption{The maintenance robot ''Sensabot'', developed by National Robotic Engineering Center (NREC) (Image credits: NREC)}
	%\vspace{-20pt}
\end{wrapfigure}
